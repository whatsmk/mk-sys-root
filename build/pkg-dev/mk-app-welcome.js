(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["MKApp_mk_app_welcome"] = factory(require("MK")["metaEngine"], require("MK.utils"), require("react"), require("react-dom"), require("immutable"));
	else
		root["MKApp_mk_app_welcome"] = factory(root["MK.metaEngine"], root["MK"]["utils"], root["React"], root["ReactDOM"], root["Immutable"]);
...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});exports.getMeta=getMeta;exports.getInitState=getInitState;function getMeta(){return{name:'root',component:'::div',className:'mk-app-welcome',children:[{name:'lbl',component:'::div',children:'{{data.content}}'}]};}function getInitState(){return{data:{content:'welcome whatsMK!'}};}
...
module.exports = {"isMKApp":true,"name":"mk-app-welcome","description":"mk-app-welcome","version":"1.0.0","license":"MIT","author":"","keywords":["mk","monkey king","react","redux","mk-js","mk-command","mk-app-welcome"],"repository":{"type":"git","url":"https://github.com/whatsmk/mk-app-welcome.git"},"bugs":{"url":"https://github.com/whatsmk/mk-app-welcome/issues"},"homepage":"https://github.com/whatsmk/mk-app-welcome#readme","scripts":{"start":"mk start","build":"mk build","pkg":"mk pkg"},"dependencies":{"mk-command":"*","mk-sdk":"*"}};
...
//# sourceMappingURL=mk-app-welcome.js.map